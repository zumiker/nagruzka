...
$stud = "SELECT studyid
        ...
        ORDER BY periodid";
$study = execq($stud);
$studyid = $study[0]['STUDYID'];
$studyid1 = $study[1]['STUDYID'];
...
<Worksheet ss:Name="Распред. нагрузки. Осенний">
  <Names>
   <NamedRange ss:Name="Print_Titles"
    ss:RefersTo="=\'Распред. нагрузки. Осенний\'!R8"/>
  </Names>';
//expaded
...
$sql = "select PREDMET, GROCODE, LEKTOR, ROOM_LEC, SEMINAR, ROOM_SEM,
    LABRAB, ROOM_LAB, PRIM, POTOK_LEK, POTOK_SEM, POTOK_LAB,  LEC, LAB, SEM
    from z_dispetch_nagruzka where divid='$div'
    AND studyid='$studyid'
    ORDER BY POR_SORT, KURS, POTOK_LEK, POTOK_SEM, POTOK_LAB,  GROCODE";
$sql1 = "select PREDMET, GROCODE, LEKTOR, ROOM_LEC, SEMINAR, ROOM_SEM,
    LABRAB, ROOM_LAB, PRIM, POTOK_LEK, POTOK_SEM, POTOK_LAB, LEC, LAB, SEM
    from z_dispetch_nagruzka where divid='$div'
     AND studyid='$studyid1'
   ORDER BY POR_SORT, KURS, POTOK_LEK, POTOK_SEM,POTOK_LAB, GROCODE";
//$main_string.= $sql.$sql1;
...
$main_string.='   <Row>
  ...
  <Worksheet ss:Name="Распред. нагрузки. Весенний">
  <Names>
   <NamedRange ss:Name="Print_Titles"
  ss:RefersTo="=\'Распред. нагрузки. Весенний\'!R8"/>
  </Names>';
...
$s='
   ...
   <Row>
    <Cell ss:StyleID="s62"><Data ss:Type="String">УМУ,</Data></Cell>
    <Cell ss:Index="3" ss:MergeAcross="9" ss:StyleID="s63"><Data ss:Type="String">РАСПРЕДЕЛЕНИЕ НАГРУЗКИ НА ВЕСЕННИЙ СЕМЕСТР '.$god .' УЧ. ГОДА</Data></Cell>
   </Row>
   <Row>
    <Cell ss:StyleID="s62"><Data ss:Type="String">отдел АСУ</Data></Cell>
    <Cell ss:Index="3" ss:MergeAcross="9" ss:StyleID="s63"><Data ss:Type="String">ПО КАФЕДРЕ '.$facname.'</Data></Cell>
   ...
   <Row ss:StyleID="s63">
    ...
    <Cell ss:MergeAcross="2" ss:StyleID="s86"><Data ss:Type="String">ЛЕКЦИИ</Data></Cell>
    <Cell ss:MergeAcross="2" ss:StyleID="s86"><Data ss:Type="String">ПРАКТИЧЕСКИЕ ЗАНЯТИЯ</Data></Cell>
    <Cell ss:MergeAcross="2" ss:StyleID="m74913616"><Data ss:Type="String">ЛАБОРАТОРНЫЕ РАБОТЫ</Data></Cell>
    <Cell ss:StyleID="s67"><Data ss:Type="String">ПРИМЕЧАНИЕ</Data></Cell>
   </Row>
   <Row ss:StyleID="s63">
    <Cell ss:StyleID="s70"/>
