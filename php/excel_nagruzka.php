...
header("Content-Disposition: attachment; filename=\"Нагрузка$time.xml\"");
...
$sql = "SELECT FIO||' '||DOL_SMALL as FIO, LECTIME, SEMTIME, LABTIME, VSEGO5, EKZ_ZACH, ITOGO7, KPR, N9, N10, N11, N12, VSEGO13, VSEGOPLAN, N15, N16, 
    ...
    FROM TEMP_PREPOD_NAGRUZKA WHERE DIVID='$divid' AND studyid='$studyid1' AND STAT_ID=1 
...
$sql1 = "SELECT FIO||' '||DOL_SMALL as FIO, LECTIME, SEMTIME, LABTIME, VSEGO5, EKZ_ZACH, ITOGO7, KPR, N9, N10, N11, N12, VSEGO13, VSEGOPLAN, N15, N16, 
  N17, N18, N19, N20, VSEGO21, N22, N23, N24,  PRIM, VSEGO25, SEMESTR, F2, F3, F4, F_VSEGO5, F6, F_ITOGO7, F8, F9, F10, F11, F12, F_VSEGO13, 
  F_VSEGOPLAN, F15, F16, F17, F18, F19, F20, F_VSEGO21, F22, F23, F24, FPRIM, F_VSEGO25, F_SEMESTR, STAT_ID, DECODE(trunc(STAVKA), STAVKA, TO_CHAR(STAVKA), TO_CHAR(STAVKA, 'FM999999999990D999999999999')) as STAVKA
  FROM TEMP_PREPOD_NAGRUZKA WHERE DIVID='$divid' AND studyid='$studyid1' AND STAT_ID=2 
  ORDER BY STAT_ID, DOL_ID DESC, FIO";
  $test = $sql1;
...
$sql2 = "SELECT  
  ...
  FROM temp_semestr_kategor WHERE DIVID='$divid' AND studyid='$studyid1' AND FOR_SORT = 1";
...
$sql3 = "SELECT FIO||' '||DOL_SMALL as FIO, LECTIME, SEMTIME, LABTIME, VSEGO5, EKZ_ZACH, ITOGO7, KPR, N9, N10, N11, N12, VSEGO13, VSEGOPLAN, N15, N16, 
  ...
  FROM TEMP_PREPOD_NAGRUZKA WHERE DIVID='$divid' AND studyid='$studyid2' AND STAT_ID=1 
  ORDER BY STAT_ID, DOL_ID DESC, FIO";
...
$sql4 = "SELECT FIO||' '||DOL_SMALL as FIO, LECTIME, SEMTIME, LABTIME, VSEGO5, EKZ_ZACH, ITOGO7, KPR, N9, N10, N11, N12, VSEGO13, VSEGOPLAN, N15, N16, 
  N17, N18, N19, N20, VSEGO21, N22, N23, N24,  PRIM, VSEGO25, SEMESTR, F2, F3, F4, F_VSEGO5, F6, F_ITOGO7, F8, F9, F10, F11, F12, F_VSEGO13, 
  F_VSEGOPLAN, F15, F16, F17, F18, F19, F20, F_VSEGO21, F22, F23, F24, FPRIM, F_VSEGO25, F_SEMESTR, STAT_ID, PREPID, DECODE(trunc(STAVKA), STAVKA, TO_CHAR(STAVKA), TO_CHAR(STAVKA, 'FM999999999990D999999999999')) as STAVKA
  FROM TEMP_PREPOD_NAGRUZKA WHERE DIVID='$divid' AND studyid='$studyid2' AND STAT_ID=2 
  ORDER BY STAT_ID, DOL_ID DESC, FIO";
...
$sql5 = "SELECT  
  ...
  sum(f_vsego25)  f_vsego25,
  sum(f_SEMESTR)f_SEMESTR
  FROM temp_semestr_kategor WHERE DIVID='$divid' AND studyid='$studyid2' AND FOR_SORT=1";
...
$sql6 = "SELECT  
  ...
  sum(f_vsego25)  f_vsego25,
  sum(f_SEMESTR)f_SEMESTR
  FROM temp_semestr_kategor WHERE DIVID='$divid' AND YEAR_GROCODE='$god' AND FOR_SORT=1";
...
$main_string .=  '<Worksheet ss:Name="Штат">
  <Table ss:ExpandedColumnCount="28" ss:ExpandedRowCount="'.(34+$sovm1+$sovm2+2*count($sql)+2*count($sql1)+2*count($sql2)+2*count($sql3)+2*count($sql4)+2*count($sql5)+2*count($sql6)).'" x:FullColumns="1"
   ...
   <Row ss:Index="4">
    <Cell ss:StyleID="s57"><Data ss:Type="String">на осенний семестр '.$god.' учебный год</Data></Cell>
    <Cell ss:StyleID="s57"/>
    <Cell ss:StyleID="s57"/>
    <Cell ss:StyleID="s57"/>
    <Cell ss:StyleID="s57"/>
  ...
  foreach ($sql2 as $key => $value) {
   ...
   <Row ss:Index="'.(23+$sovm1+2*count($sql)+2*count($sql1)+2*count($sql2)).'">
    <Cell ss:StyleID="s57"><Data ss:Type="String">на весенний семестр '.$god.' учебный год</Data></Cell>
    <Cell ss:StyleID="s57"/>
    <Cell ss:StyleID="s57"/>
    <Cell ss:StyleID="s57"/>
    <Cell ss:StyleID="s57"/>
...
$sql = "SELECT FIO||' '||DOL_SMALL as FIO, LECTIME, SEMTIME, LABTIME, VSEGO5, EKZ_ZACH, ITOGO7, KPR, N9, N10, N11, N12, VSEGO13, VSEGOPLAN, N15, N16, 
    ...
    FROM TEMP_PREPOD_NAGRUZKA WHERE DIVID='$divid' AND studyid='$studyid1' AND STAT_ID=4 
    ORDER BY STAT_ID, DOL_ID DESC, FIO";
$sql = execq($sql, true);
...
$sql2 = "SELECT   
  ...
  sum(f_vsego25)  f_vsego25,
  sum(f_SEMESTR)f_SEMESTR
  FROM temp_semestr_kategor WHERE DIVID='$divid' AND studyid='$studyid1' AND FOR_SORT = 2";
$sql2 = execq($sql2, true);
...
$sql3 = "SELECT FIO||' '||DOL_SMALL as FIO, LECTIME, SEMTIME, LABTIME, VSEGO5, EKZ_ZACH, ITOGO7, KPR, N9, N10, N11, N12, VSEGO13, VSEGOPLAN, N15, N16, 
  ...
  FROM TEMP_PREPOD_NAGRUZKA WHERE DIVID='$divid' AND studyid='$studyid2' AND STAT_ID=4 
  ORDER BY STAT_ID, DOL_ID DESC, FIO";
$sql3 = execq($sql3, true);
...
$sql5 = "SELECT 
  ...
  sum(f_vsego25)  f_vsego25,
  sum(f_SEMESTR)f_SEMESTR
  FROM temp_semestr_kategor WHERE DIVID='$divid' AND studyid='$studyid2' AND FOR_SORT=2";
$sql5 = execq($sql5, true);
...
$sql6 = "SELECT   
  ...
  sum(f_vsego25)  f_vsego25,
  sum(f_SEMESTR)f_SEMESTR
  FROM temp_semestr_kategor WHERE DIVID='$divid' AND YEAR_GROCODE='$god' AND FOR_SORT=2";
$sql6 = execq($sql6, true);
...
$sql = "SELECT FIO||' '||DOL_SMALL as FIO, LECTIME, SEMTIME, LABTIME, VSEGO5, EKZ_ZACH, ITOGO7, KPR, N9, N10, N11, N12, VSEGO13, VSEGOPLAN, N15, N16, 
    N17, N18, N19, N20, VSEGO21, N22, N23, N24,  PRIM, VSEGO25, SEMESTR, F2, F3, F4, F_VSEGO5, F6, F_ITOGO7, F8, F9, F10, F11, F12, F_VSEGO13, 
    F_VSEGOPLAN, F15, F16, F17, F18, F19, F20, F_VSEGO21, F22, F23, F24, FPRIM, F_VSEGO25, F_SEMESTR, DOL_SMALL, STAT_ID, DECODE(trunc(STAVKA), STAVKA, TO_CHAR(STAVKA), TO_CHAR(STAVKA, 'FM999999999990D999999999999')) as STAVKA
    FROM TEMP_PREPOD_NAGRUZKA WHERE DIVID='$divid' AND studyid='$studyid1' AND STAT_ID IN (3,5) 
    ORDER BY STAT_ID, DOL_ID DESC, FIO";
$sql = execq($sql, true);
...
$sql2 = "SELECT   
  ...
  sum(f_vsego25)  f_vsego25,
  sum(f_SEMESTR)f_SEMESTR
  FROM temp_semestr_kategor WHERE DIVID='$divid' AND studyid='$studyid1' AND FOR_SORT = 3";
$sql2 = execq($sql2, true);
...
$sql3 = "SELECT FIO||' '||DOL_SMALL as FIO, LECTIME, SEMTIME, LABTIME, VSEGO5, EKZ_ZACH, ITOGO7, KPR, N9, N10, N11, N12, VSEGO13, VSEGOPLAN, N15, N16, 
  N17, N18, N19, N20, VSEGO21, N22, N23, N24,  PRIM, VSEGO25, SEMESTR, F2, F3, F4, F_VSEGO5, F6, F_ITOGO7, F8, F9, F10, F11, F12, F_VSEGO13, 
  F_VSEGOPLAN, F15, F16, F17, F18, F19, F20, F_VSEGO21, F22, F23, F24, FPRIM, F_VSEGO25, F_SEMESTR, DOL_SMALL, STAT_ID, PREPID, DECODE(trunc(STAVKA), STAVKA, TO_CHAR(STAVKA), TO_CHAR(STAVKA, 'FM999999999990D999999999999')) as STAVKA
  FROM TEMP_PREPOD_NAGRUZKA WHERE DIVID='$divid' AND studyid='$studyid2' AND STAT_ID IN (3,5)
  ORDER BY STAT_ID, DOL_ID DESC, FIO";
$sql3 = execq($sql3, true);
...
$sql5 = "SELECT   
  ...
  sum(f_vsego25)  f_vsego25,
  sum(f_SEMESTR)f_SEMESTR
  FROM temp_semestr_kategor WHERE DIVID='$divid' AND studyid='$studyid2' AND FOR_SORT=3";
$sql5 = execq($sql5, true);
...
$sql6 = "SELECT   
  ...
  sum(f_vsego25)  f_vsego25,
  sum(f_SEMESTR)f_SEMESTR
  FROM temp_semestr_kategor WHERE DIVID='$divid' AND YEAR_GROCODE='$god' AND FOR_SORT=3";
$sql6 = execq($sql6, true);
...
$sql3 = "SELECT   
  ...
  sum(f_vsego25)  f_vsego25,
  sum(f_SEMESTR) f_SEMESTR
  FROM temp_semestr_kategor WHERE DIVID='$divid' AND studyid='$studyid1'";
$sql3 = execq($sql3, true);
...
$sql7 = "SELECT   
  ...
  sum(f_vsego25)  f_vsego25,
  sum(f_SEMESTR) f_SEMESTR
  FROM temp_semestr_kategor WHERE DIVID='$divid' AND studyid='$studyid2'";
...
$sql8 = "SELECT   
  ...
  sum(f_vsego25)  f_vsego25,
  sum(f_SEMESTR) f_SEMESTR
  FROM temp_semestr_kategor WHERE DIVID='$divid' AND YEAR_GROCODE='$god'";
...
$main_string .=  '<Worksheet ss:Name="Годовая">
  ...
  for ($i = 1; $i <= 7; $i ++){
    ...
    $sql="select DIVID, YEAR_GROCODE, sum(LECTIME) LECTIME,
      ...
      sum(f22) f22, sum(f23) f23, sum(f24) f24, sum(fPRIM) fprim, 
      sum(f_vsego25)  f_vsego25,
      sum(f_GOD)f_GOD, sum(KOL_PREPOD) KOL_PREPOD, sum(KOL_STAVKI) KOL_STAVKI FROM TEMP_GOD WHERE ".$where;
      $sql = execq($sql, true);
      $value = $sql[0];
      $stavka = $value['KOL_STAVKI'];
      if ($stavka[0] == "."){
        $stavka = "0".$stavka;
      }
