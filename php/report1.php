 ...
 <Worksheet ss:Name="Штат">
   ...
   <Row>
    ...
    <Cell ss:StyleID="s64"><Data ss:Type="String">'.trim($F_SEMESTR).'</Data></Cell>';
                if($zagod==1) $s.='<Cell ss:StyleID="s64"><Data ss:Type="String">'.trim($fvsegogod).'</Data></Cell>';$s.='
        ...
        foreach($cur1 as $k=>$row){
		 ...
		 n22,  n23, n24,  prim,
		  ...
		  f16,  f17,  f18,  f19,  f20,
		   ...
		   f_vsego25,
		  f_SEMESTR
		 from temp_semestr_kategor  WHERE DIVID='$kaf' AND studyid='$studyid' AND FOR_SORT=2";
            ...
            foreach($cur as $k=>$row){
                ...
                if($zagod==1){
                    $sql2="select sum(GOD) GOD,
		          	sum(F_GOD) F_GOD
		      	from temp_god
		        	WHERE  DIVID='$kaf' AND FOR_SORT=2";
                    $j=26;
                    $cur2=execq($sql2);
                    $vsegogod=$cur2[0]['GOD'];
                    $sum[$j]+=$vsegogod;
        ...
        foreach($cur1 as $k=>$row){
		 ...
		 n22,  n23, n24,  prim,
		  ...
		  f16,  f17,  f18,  f19,  f20,
		   ...
		   f_vsego25,
		  f_SEMESTR
		 from temp_semestr_kategor  WHERE DIVID='$kaf' AND studyid='$studyid' AND FOR_SORT=3";
            ...
            $sql2="select sum(GOD) GOD,
		          	sum(F_GOD) F_GOD
		      	from temp_god
		        	WHERE  DIVID='$kaf' AND FOR_SORT=3";
                    $j=26;
                    $cur2=execq($sql2);
                    $vsegogod=$cur2[0]['GOD'];
                    $sum[$j]+=$vsegogod;
